...
maxiPago's SDK for iOS helps integrate Kount's fraud fighting solution into
your iOS app.
...
Download the [maxiPago iOS SDK](https://github.com/) and
unzip the file in a folder separate from your project.

Open up your app in Xcode.
In Finder, drag the MaxiPagoDataCollector folder into the top level of your project, and
...
configuration for location collection, and the maxiPago environment. While
